            ...
            "items": [
              {
                ...
                "d": "• O que estudar: base 2 vs base 10, converter decimal↔binário manualmente, tabela de potências de 2 (1,2,4,8,16,32,64,128,256), por que computadores usam binário (transistores = on/off)\n• Exercícios: converter 42 para binário, converter 10101 para decimal, somar dois números binários na mão\n• Pesquisar: 'binary number system explained simply', 'como converter decimal para binário'"
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: rwx = read/write/execute pra owner/group/others..\n• Conceitos-chave: chown user:group arquivo.. Grupos: compartilhar acesso.\n• Pesquisar: \"Permissoes rwx usuarios grupos chown tutorial\" no YouTube, \"Permissoes rwx usuarios grupos chown explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: python.org/downloads..\n• Conceitos-chave: Windows: marque Add to PATH.. Linux: sudo apt install python3.. VS Code + extensao Python (Microsoft).. Teste: python3 -c \"print('Oi')\".\n• Praticar: Teste: python3 -c \"print('Oi')\".\n• Pesquisar: \"Instalar Python 312 e configurar VS Code tutorial\" no YouTube, \"Instalar Python 312 e configurar VS Code explained\" no Google."
              },
              {
                ...
                "d": "• O que é: python3 no terminal = modo interativo (>>>)..\n• Conceitos-chave: Jupyter: pip install notebook.. Google Colab: online gratis.\n• Pesquisar: \"REPL interativo e Jupyter Notebook tutorial\" no YouTube, \"REPL interativo e Jupyter Notebook explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: f'{val:.2f}' f'{val:,}'..\n• Conceitos-chave: re.findall(r'\\d+', texto).. Padroes: \\d \\w \\s.\n• Pesquisar: \"Fstrings avancadas e regex basico modulo tutorial\" no YouTube, \"Fstrings avancadas e regex basico modulo explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: while cond: repete..\n• Conceitos-chave: continue: pula.. for...else: roda se NAO houve break.. Cuidado loop infinito!.\n• Pesquisar: \"while break continue else em loops tutorial\" no YouTube, \"while break continue else em loops explained\" no Google."
              },
              {
                ...
                "d": "• O que é: for i in range(3): for j in range(3): = O(n2)..\n• Conceitos-chave: Exercicio: piramide de *, tabuada, pattern printing.\n• Pesquisar: \"Loops aninhados e padroes comuns tutorial\" no YouTube, \"Loops aninhados e padroes comuns explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: [x**2 for x in range(10)]..\n• Conceitos-chave: {k:v for ...}.. a,*rest=[1,2,3,4].\n• Pesquisar: \"Comprehensions e desempacotamento tutorial\" no YouTube, \"Comprehensions e desempacotamento explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: def media(notas): '''Calcula media.''' return sum(notas)/len(notas)..\n• Conceitos-chave: Uma funcao faz UMA coisa.\n• Pesquisar: \"def parametros return docstrings tutorial\" no YouTube, \"def parametros return docstrings explained\" no Google."
              },
              {
                ...
                "d": "• O que é: def f(x,y=10)..\n• Conceitos-chave: *args: tupla.. **kwargs: dict.. LEGB: Local>Enclosing>Global>Built-in.\n• Pesquisar: \"Default args kwargs escopo LEGB tutorial\" no YouTube, \"Default args kwargs escopo LEGB explained\" no Google."
              },
              {
                ...
                "d": "• O que é: lambda x: x*2..\n• Conceitos-chave: Funcoes sao objetos.. @decorator = wrapper.. @property @staticmethod.\n• Pesquisar: \"Lambda funcoes como objetos decorators tutorial\" no YouTube, \"Lambda funcoes como objetos decorators explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: try: arriscado / except ValueError: tratar / else: se ok / finally: sempre..\n• Conceitos-chave: raise CustomError().\n• Pesquisar: \"tryexceptelsefinally excecoes customizad tutorial\" no YouTube, \"tryexceptelsefinally excecoes customizad explained\" no Google."
              },
              {
                ...
                "d": "• O que é: import math..\n• Conceitos-chave: pip install pacote.. python3 -m venv .venv.. requirements.txt.. NUNCA instale globalmente.\n• Pesquisar: \"Modulos imports pip venv ambientes virtu tutorial\" no YouTube, \"Modulos imports pip venv ambientes virtu explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: P(A|B) = P(B|A)*P(A)/P(B)..\n• Conceitos-chave: Base de filtros de spam, diagnostico.\n• Exemplos: Exemplo: teste medico positivo, qual chance de ter doenca? Bayes atualiza crencas com evidencia..\n• Praticar: Exemplo: teste medico positivo, qual chance de ter doenca? Bayes atualiza crencas com evidencia..\n• Pesquisar: \"Probabilidade condicional e Teorema de B tutorial\" no YouTube, \"Probabilidade condicional e Teorema de B explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: W=F*d*cos(theta)..\n• Conceitos-chave: Conservacao: Ec+Ep=constante (sem atrito).. Potencia=W/t.. Joule, Watt.\n• Pesquisar: \"Trabalho energia cinetica potencial cons tutorial\" no YouTube, \"Trabalho energia cinetica potencial cons explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Tensao=diferenca de potencial..\n• Conceitos-chave: Capacitor: C=Q/V.. Energia: U=CV2/2.. Capacitores em serie/paralelo.. Filtros RC.\n• Pesquisar: \"Potencial eletrico tensao capacitores en tutorial\" no YouTube, \"Potencial eletrico tensao capacitores en explained\" no Google."
              },
              {
                ...
                "d": "• O que é: Potencia=VI=I2R..\n• Conceitos-chave: Kirchhoff: soma tensoes no laco=0, soma correntes no no=0.. Resolver circuitos com malhas.\n• Pesquisar: \"Corrente resistencia Lei de Ohm circuito tutorial\" no YouTube, \"Corrente resistencia Lei de Ohm circuito explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: <table> <tr> <td>..\n• Conceitos-chave: <ul> <ol> <li>.. <img src alt>.. <video> <audio>.. Sempre alt em imagens.\n• Pesquisar: \"Tabelas listas links imagens multimedia tutorial\" no YouTube, \"Tabelas listas links imagens multimedia explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: PK: identifica unico (nunca nulo)..\n• Conceitos-chave: FK: referencia outra tabela.. UNIQUE: sem duplicatas.\n• Pesquisar: \"Chaves primarias PK estrangeiras FK unic tutorial\" no YouTube, \"Chaves primarias PK estrangeiras FK unic explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Karnaugh: simplificacao visual (2-4 variaveis)..\n• Conceitos-chave: Minimizar logica = menos portas = mais barato/rapido.\n• Pesquisar: \"Algebra booleana simplificacao mapas de  tutorial\" no YouTube, \"Algebra booleana simplificacao mapas de  explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Trie: autocompletar..\n• Conceitos-chave: Segment: range queries.. Union-Find: componentes conectados.\n• Pesquisar: \"Trie Segment Tree UnionFind tutorial\" no YouTube, \"Trie Segment Tree UnionFind explained\" no Google."
              }
            ]
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Linear O(n)..\n• Conceitos-chave: Binaria O(log n) em dados ordenados.. 1 bilhao = ~30 passos.\n• Pesquisar: \"Busca linear e binaria tutorial\" no YouTube, \"Busca linear e binaria explained\" no Google."
              },
              {
              ...
              },
              {
                ...
                "d": "• O que é: D&C: dividir>resolver>combinar..\n• Conceitos-chave: Backtracking: explorar+podar (N-Queens, Sudoku).\n• Pesquisar: \"Recursao Divide  Conquer Backtracking tutorial\" no YouTube, \"Recursao Divide  Conquer Backtracking explained\" no Google."
              },
              {
                ...
                "d": "• O que é: Escolha otima local..\n• Conceitos-chave: Scheduling, Huffman, Kruskal, Dijkstra.\n• Pesquisar: \"Algoritmos Gulosos Greedy tutorial\" no YouTube, \"Algoritmos Gulosos Greedy explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: class Pessoa: def __init__(self,nome): self.nome=nome..\n• Conceitos-chave: Objeto: p=Pessoa('Kaio').\n• Pesquisar: \"Classes objetos __init__ self tutorial\" no YouTube, \"Classes objetos __init__ self explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: yield: lazy (nao carrega tudo)..\n• Conceitos-chave: itertools: chain, product, combinations, groupby.\n• Pesquisar: \"Generators iterators itertools tutorial\" no YouTube, \"Generators iterators itertools explained\" no Google."
              },
              {
                ...
                "d": "• O que é: with: __enter__/__exit__..\n• Conceitos-chave: def f(x: int) -> str.. mypy pra checagem estatica.\n• Pesquisar: \"Context managers type hints mypy tutorial\" no YouTube, \"Context managers type hints mypy explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Linear: y=wx+b, MSE, gradiente..\n• Conceitos-chave: Logistica: sigmoid, classificacao..\n• Praticar: Implemente do zero primeiro!.\n• Pesquisar: \"Regressao Linear e Logistica do zero  sk tutorial\" no YouTube, \"Regressao Linear e Logistica do zero  sk explained\" no Google."
              },
              {
                ...
                "d": "• O que é: KNN: vizinhos..\n• Conceitos-chave: SVM: hiperplano.. NB: probabilistico.. K-Means: centroides.. DBSCAN: densidade.\n• Pesquisar: \"KNN SVM Naive Bayes Clustering KMeans DB tutorial\" no YouTube, \"KNN SVM Naive Bayes Clustering KMeans DB explained\" no Google."
              },
              {
                ...
                "d": "• O que é: Gini/entropia..\n• Conceitos-chave: Bagging (RF) vs Boosting (XGB).. Muito usados em producao e Kaggle.\n• Pesquisar: \"Arvores Random Forest XGBoostLightGBM tutorial\" no YouTube, \"Arvores Random Forest XGBoostLightGBM explained\" no Google."
              },
              {
                ...
                "d": "• O que é: StandardScaler/MinMax..\n• Conceitos-chave: L1(Lasso) L2(Ridge) ElasticNet.. Dropout, early stopping.\n• Pesquisar: \"Feature Engineering Scaling Regularizaca tutorial\" no YouTube, \"Feature Engineering Scaling Regularizaca explained\" no Google."
              },
              {
                ...
                "d": "• O que é: Pipeline encadeia..\n• Conceitos-chave: Grid/RandomSearch.. Accuracy, Precision, Recall, F1, ROC-AUC.\n• Pesquisar: \"Pipeline CrossValidation GridSearch Metr tutorial\" no YouTube, \"Pipeline CrossValidation GridSearch Metr explained\" no Google."
              }
            ]
          },
          {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: JWT: tokens stateless..\n• Conceitos-chave: OAuth: login social.. Validacao: Zod/Pydantic.. Swagger: docs.. WebSocket: real-time.\n• Pesquisar: \"Auth JWTOAuth validacao WebSockets Swagg tutorial\" no YouTube, \"Auth JWTOAuth validacao WebSockets Swagg explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Redis/Memcached..\n• Conceitos-chave: CDN: distribuir estaticos.. LB: round-robin, least-connections.. Rate limit: proteger API.\n• Pesquisar: \"Caching CDN Load Balancing Rate Limiting tutorial\" no YouTube, \"Caching CDN Load Balancing Rate Limiting explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: Neuronio: soma ponderada + ativacao..\n• Conceitos-chave: Forward pass > loss > backward pass..\n• Praticar: Implemente do zero com NumPy!.\n• Pesquisar: \"Perceptron MLP Backpropagation do zero tutorial\" no YouTube, \"Perceptron MLP Backpropagation do zero explained\" no Google."
              },
              {
          ...
          },
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Tarefas NLP classicas..\n• Conceitos-chave: Pipeline HF facilita.. Fine-tune pra dominio especifico.\n• Pesquisar: \"Sentiment NER summarization question ans tutorial\" no YouTube, \"Sentiment NER summarization question ans explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Texto>vetor (OpenAI embeddings, Sentence Transformers)..\n• Conceitos-chave: Busca por similaridade.. pgvector: Postgres nativo.\n• Pesquisar: \"Embeddings e Vector Databases Pinecone C tutorial\" no YouTube, \"Embeddings e Vector Databases Pinecone C explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Cinematica: geometria do movimento..\n• Conceitos-chave: SLAM: mapear+localizar.. Sensor fusion: combinar dados.\n• Pesquisar: \"Cinematica SLAM sensores LIDAR IMU camer tutorial\" no YouTube, \"Cinematica SLAM sensores LIDAR IMU camer explained\" no Google."
              },
              {
            ...
            "items": [
              {
                ...
                "d": "• O que é: CAP: Consistency vs Availability em particao..\n• Conceitos-chave: Raft: consenso pratico.. Eventual consistency.\n• Pesquisar: \"CAP PACELC consenso RaftPaxos consistenc tutorial\" no YouTube, \"CAP PACELC consenso RaftPaxos consistenc explained\" no Google."
              },
              {
              ...
              },
              {
                ...
                "d": "• O que é: gRPC: rapido, tipado..\n• Conceitos-chave: Protobuf: serializacao eficiente.. Service mesh: observabilidade entre servicos.\n• Pesquisar: \"gRPC Protocol Buffers service mesh Istio tutorial\" no YouTube, \"gRPC Protocol Buffers service mesh Istio explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Feature store: features reutilizaveis..\n• Conceitos-chave: Airflow: orquestrar.. dbt: transformar dados.\n• Pesquisar: \"Feature Stores Data Pipelines Airflow db tutorial\" no YouTube, \"Feature Stores Data Pipelines Airflow db explained\" no Google."
              },
              {
              ...
              },
              {
                ...
                "d": "• O que é: Testar dados, modelo, pipeline..\n• Conceitos-chave: DVC: versionar dados.. Docker + pipeline = reproduzivel.\n• Pesquisar: \"CICD para ML testes de modelo reproducib tutorial\" no YouTube, \"CICD para ML testes de modelo reproducib explained\" no Google."
              },
              {
        ...
        "topics": [
          {
            ...
            "items": [
              ...
              },
              {
                ...
                "d": "• O que é: Mais dados + mais parametros = melhor (ate certo ponto)..\n• Conceitos-chave: MoE: ativar subset.. Eficiencia.\n• Pesquisar: \"Scaling Laws Mixture of Experts Sparse M tutorial\" no YouTube, \"Scaling Laws Mixture of Experts Sparse M explained\" no Google."
              },
              {
